...
See [`CITATION.cff`](https://github.com/System9ai/substrate-alignment/blob/main/CITATION.cff). Until the tagged release, cite the [preprint](docs/preprint/preprint.md) or the repository:
