...
CI runs these commands plus the conformance probes, every bundled example, and the federal-procurement guard, matrixed on Python 3.11–3.14. Local runs that pass will pass in CI.
