...
**Closes the loophole:** sustained operation past the system's healthy capacity envelope.

## 5. Pair-coupling integrity

A conforming implementation MUST provide a pair-coupling state machine that tracks each entity-pair through:

- `COUPLED` — active mutual coupling.
- `ATTENUATING` — declining cadence, ghosting risk.
