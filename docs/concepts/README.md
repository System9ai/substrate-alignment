...
| [`governed-ascent.md`](governed-ascent.md) | Hill climbing made substrate-aligned: each step carries a short-cycle-vs-long-cycle dimension and the climb is certified as worth making, so greedy local ascent cannot mistake the local gradient for value. |
