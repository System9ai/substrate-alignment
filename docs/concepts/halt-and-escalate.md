...
| `SUBSTRATE_MODE_REVIEW` | **Yes** | Conditions warrant operator review; entity continues with reduced authority, and gates that consult the state widen their refusal envelope. |
