...
> **Status.** This case study reflects the production deployment as of the substrate-alignment v0.1.0 extraction. Subsequent revisions land alongside platform releases.
