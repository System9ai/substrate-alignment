...
# The work-zone midpoint is the inner ninth 4/9 ≈ 0.444 (WORK_ZONE_MIDPOINT),
# confluent with the arithmetic midpoint (1/φ² + 0.50)/2 ≈ 0.441.
_WORK_TARGET_FRACTION = WORK_ZONE_MIDPOINT
