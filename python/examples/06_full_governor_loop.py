...
def main() -> None:
    ...
    # ──────────────────────────────────────────────────────────────────
    # [3] The host application's current request rate is 50%. The
    # resistance band classifies the system as stressed.
    # ──────────────────────────────────────────────────────────────────
    utilization = 0.50
    band_class = classify_band(utilization)
    print(
        f"[3] system band (util=0.50)=  {band_class.value}  "
        f"(resistance band classifies utilisation)"
    )
