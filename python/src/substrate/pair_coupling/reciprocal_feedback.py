...
pair-coupled agents (Phase 118) must observe each other symmetrically
...
3. Both attestations cite Phase 105
...
class Attestation:
    ...
    """Phase 105 evidence-trust score for this attestation, in [0, 1]."""
