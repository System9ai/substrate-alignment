...
produces false-positives from cultural variation, neurodivergence,
current health state, etc.). The platform commits to tells as
substrate-state-data feeding interpretation, never as standalone
judgment.
"""
