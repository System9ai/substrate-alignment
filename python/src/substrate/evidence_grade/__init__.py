...
The composer is host-agnostic. Host applications (a cognitive-fusion
store, a perception store, project-specific stores) declare conformance
by implementing the :class:`SubstrateStateClaim` Protocol on their
