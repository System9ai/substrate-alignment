...
:class:`substrate.harness.InversionDetector`
Protocol. Detects the 180° moral-inversion pattern
described in
...
* Composition. :meth:`detect` returns a rich
  ...
  :class:`SubstrateTraceLedger`. Optional context from
  the :class:`DriftPatternMatcher` strengthens specific
