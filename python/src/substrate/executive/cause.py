...
The :class:`HallmarkSource` is scale-agnostic (any entity/cell/node), distinct
from the MNEMOSYNE cancer report — the tumor/runaway hallmarks generalised
beyond one consumer.
"""
...
class HallmarkSource(Protocol):  # pylint: disable=too-few-public-methods
    """Scale-agnostic hallmark provider (NOT the MNEMOSYNE CancerReport)."""
