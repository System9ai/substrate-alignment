...
* :class:`DriftPatternMatcher` (seven pattern categories)
* :class:`HeuristicInversionDetector` (180° inversion)
* :class:`DefensiveModulationEngine` (eight attack
  patterns)
* :class:`GoldenRuleProbe` (cross-tradition reciprocity)
* :class:`NetPotentialGainGate` (NET_NEGATIVE rate)
