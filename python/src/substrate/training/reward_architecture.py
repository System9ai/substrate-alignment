...
class SubstrateAlignedTrainingRewards:  # pylint: disable=too-few-public-methods
    """Substrate-aligned training-reward orchestrator (Plan 3art 34)."""
