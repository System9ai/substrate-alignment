...
* **Awareness verification**: mode-3 awareness verifier.
* **5D behavioral probe suite**: modeling mode operational probes.
* **Voting precondition**: substrate-aware voting gate.
* **authority-pressure failure probe suite**: failure-mode probes.
* **Golden Rule probe**: reciprocity probe.
* **Drift posture**: drift-signal aggregator verdict.
