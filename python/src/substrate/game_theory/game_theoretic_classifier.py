...
theoretic surface every later primitive consumes.
...
* :class:`PayoffEntry` and :class:`PayoffStructure` are the canonical
  payoff vocabulary the rest of the suite consumes.
* The classifier's output is the **input** to the tit-for-tat
  protocol, the Folk Theorem verifier, the mechanism designer,
  and the game-theoretic-awareness verifier.
"""
...
class GameTheoreticContext:  # pylint: disable=too-many-instance-attributes
    """Classifier output: the foundational vocabulary."""
