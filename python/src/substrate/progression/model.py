"""Per-entity progression value model (Plan 3art 31).

Pure-logic value types. Cells, nodes, and orgs each carry their own
:class:`SubstrateStateTrajectoryProgression` instance; the DAO at
`app/core/db/directory/substrate/dao_substrate_trajectory_progression.py`
persists snapshots.
"""
